/* ==========================================================================
   ...
   Why a hand-rolled tokenizer instead of highlight.js:
     1. Code lives in <script type="text/template"> blocks, so C# generics
        (IEnumerable<T>, ImmutableArray<string>) need no HTML escaping and the
        snippets stay copy-pasteable from the real source files.
     2. The interactive widgets build code line-by-line at runtime; sharing one
        renderer keeps the static slides and the animated panels identical.
   ========================================================================== */
window.DeckCode = (function () {
  ...
  const LANGS = { csharp: csharp, markdown: markdown, text: esc };
